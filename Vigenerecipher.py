#Program by Chukwuka Kamsiyochukwu Gideon(0xg0df4th3r)
...
def main():
    print('''Vigenere Cipher, by 0xg0df4th3r
    The Vigenere Cipher is a polyalphabetic substitution cipher that was powerful enough to remain unbroken for centuries.''')
    
    #Let the user specify if thy are encrypting or decrypting:
    ...
    #Perform the encryption and decryption of the message
    if myMode == 'encrypt':
